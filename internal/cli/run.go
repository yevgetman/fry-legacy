...
func updateBuildStatusAudit(status *agent.BuildStatus, sprintNum int, auditResult *audit.AuditResult) {
	...
	status.Sprints[idx].Audit = &agent.AuditStatus{
		...
		StopReason:    auditResult.StopReason,
...
func updateBuildStatusAuditProgress(status *agent.BuildStatus, sprintNum int, progress audit.AuditProgress) {
	...
	status.Sprints[idx].Audit = &agent.AuditStatus{
		...
		Metrics: &agent.AuditMetricsSnapshot{
			...
			BehaviorUnchanged:        progress.Metrics.BehaviorUnchanged,
			BehaviorEscalations:      progress.Metrics.BehaviorEscalations,
			...
			LastCycleFixYield:        progress.Metrics.LastCycleFixYield,
			LastCycleVerifyYield:     progress.Metrics.LastCycleVerifyYield,
			LastCycleNoOpRate:        progress.Metrics.LastCycleNoOpRate,
			LastCycleMsPerResolution: progress.Metrics.LastCycleMsPerResolution,
			TrailingFixYield:         progress.Metrics.TrailingFixYield,
...
func buildStatusAuditMetricsSnapshot(metrics *audit.AuditMetrics) *agent.AuditMetricsSnapshot {
	...
	return &agent.AuditMetricsSnapshot{
		...
		BehaviorUnchanged:        snapshot.BehaviorUnchanged,
		BehaviorEscalations:      snapshot.BehaviorEscalations,
		...
		LastCycleFixYield:        snapshot.LastCycleFixYield,
		LastCycleVerifyYield:     snapshot.LastCycleVerifyYield,
		LastCycleNoOpRate:        snapshot.LastCycleNoOpRate,
		LastCycleMsPerResolution: snapshot.LastCycleMsPerResolution,
		TrailingFixYield:         snapshot.TrailingFixYield,
