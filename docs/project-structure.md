...
your-project/
  ...
  .fry-config/                              # Persistent project config (gitignored, not affected by archive/clean)
    ...
    codebase.md                          #   Semantic codebase understanding (used in sprint and sprint-audit prompts, persistent)
  ...
  .fry/                                  # Generated artifacts (gitignored)
    ...
    audit-prompt.md                      #   Assembled sprint audit/fix/verify prompt (transient, cleaned up after audit)
...
| `.fry/audit-prompt.md` | Assembled sprint audit/fix/verify prompt (transient) | `fry run` at runtime |
